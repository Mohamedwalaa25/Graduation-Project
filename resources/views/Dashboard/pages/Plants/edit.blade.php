{{-- Edit Plant Modal --}}
<div class="modal fade" id="edit" tabindex="-1" aria-labelledby="editPlantModalLabel" aria-hidden="true"
     data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-xl">
        <div class="modal-content shadow-lg border-0">
            <div class="modal-header bg-warning text-dark">
                <h1 class="modal-title fs-4 fw-bold" id="editPlantModalLabel">
                    <i class="bi bi-pencil-square me-2"></i>Edit Plant
                </h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form method="POST" action="{{ url('dashboard/plant/update') }}" enctype="multipart/form-data" id="editPlantForm">
                @csrf
                ...
                <div class="modal-body p-4">
                    ...
                    <div class="row mb-4">
                        <div class="col-12">
                            ...
                            <div class="d-flex justify-content-between mt-2">
                                <small class="text-warning fw-bold">Basic Info</small>
                    ...
                    <!-- Tab Navigation -->
                    <ul class="nav nav-pills nav-justified mb-4" id="editPlantTabs" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="edit-basic-tab" data-bs-toggle="pill" data-bs-target="#edit-basic-info" type="button" role="tab">
                                <i class="bi bi-info-circle me-1"></i>Basic Information
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="edit-environment-tab" data-bs-toggle="pill" data-bs-target="#edit-environment-info" type="button" role="tab">
                                <i class="bi bi-thermometer-sun me-1"></i>Environment
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="edit-classification-tab" data-bs-toggle="pill" data-bs-target="#edit-classification-info" type="button" role="tab">
                                <i class="bi bi-diagram-3 me-1"></i>Classification
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="edit-media-tab" data-bs-toggle="pill" data-bs-target="#edit-media-info" type="button" role="tab">
                    ...
                    <!-- Tab Content -->
                    <div class="tab-content" id="editPlantTabContent">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" required name="name" class="form-control form-control-lg" id="edit_name" placeholder="Enter plant name">
                                                <x-inline_alert name='name'></x-inline_alert>
                                            </div>

                                            <div class="mb-3">
                                                <label for="edit_botanical_name" class="form-label fw-semibold">
                                                    <i class="bi bi-book text-info me-1"></i>Botanical Name <span class="text-danger">*</span>
                                                </label>
                                                <input type="text" required name="botanical_name" class="form-control" id="edit_botanical_name" placeholder="Enter botanical name">
                                                <x-inline_alert name='botanical_name'></x-inline_alert>
                                            </div>

                                            <div class="mb-3">
                                                <label for="edit_scientific_name" class="form-label fw-semibold">
                                                    <i class="bi bi-mortarboard text-warning me-1"></i>Scientific Name <span class="text-danger">*</span>
                                                </label>
                                                <input type="text" required name="scientific_name" class="form-control" id="edit_scientific_name" placeholder="Enter scientific name">
                                                <x-inline_alert name='scientific_name'></x-inline_alert>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="edit_also_known_as" class="form-label fw-semibold">
                                                    <i class="bi bi-tags text-secondary me-1"></i>Also Known As
                                                </label>
                                                <input type="text" name="also_known_as" class="form-control" id="edit_also_known_as" placeholder="Common names (comma separated)">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea required name="description" class="form-control" id="edit_description" rows="4" placeholder="Describe the plant characteristics, uses, and features..."></textarea>
                            ...
                            <div class="card border-0 bg-light mt-3">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="edit_toughness" class="form-label fw-semibold">
                                                    <i class="bi bi-shield-check text-success me-1"></i>Toughness <span class="text-danger">*</span>
                                                </label>
                                                <select required name="toughness" class="form-select" id="edit_toughness">
                                            ...
                                            <div class="mb-3">
                                                <label for="edit_maintenance" class="form-label fw-semibold">
                                                    <i class="bi bi-tools text-warning me-1"></i>Maintenance <span class="text-danger">*</span>
                                                </label>
                                                <select required name="maintenance" class="form-select" id="edit_maintenance">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="edit_sunlight" class="form-label fw-semibold">
                                                    <i class="bi bi-sun text-warning me-1"></i>Sunlight Requirements <span class="text-danger">*</span>
                                                </label>
                                                <select required name="sunlight" class="form-select" id="edit_sunlight">
                                            ...
                                            <div class="mb-3">
                                                <label for="edit_hardness_zone" class="form-label fw-semibold">
                                                ...
                                                <input type="text" required name="hardness_zone" class="form-control" id="edit_hardness_zone" placeholder="e.g., 5-9">
                        ...
                        <!-- Environment Tab -->
                        <div class="tab-pane fade" id="edit-environment-info" role="tabpanel">
                            <div class="card border-0 bg-light">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="edit_min_ph" class="form-label fw-semibold">
                                                    <i class="bi bi-droplet text-primary me-1"></i>Minimum pH <span class="text-danger">*</span>
                                                </label>
                                                <div class="input-group">
                                                    <span class="input-group-text">pH</span>
                                                    <input type="number" step="0.1" min="0" max="14" required name="min_ph" class="form-control" id="edit_min_ph" placeholder="6.0">
                                                </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="edit_max_ph" class="form-label fw-semibold">
                                                    <i class="bi bi-droplet text-primary me-1"></i>Maximum pH <span class="text-danger">*</span>
                                                </label>
                                                <div class="input-group">
                                                    <span class="input-group-text">pH</span>
                                                    <input type="number" step="0.1" min="0" max="14" required name="max_ph" class="form-control" id="edit_max_ph" placeholder="7.5">
                                                </div>
                                                <small class="text-muted">Range: 0-14</small>
                            ...
                            <div class="card border-0 bg-light mt-3">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="edit_min_tp" class="form-label fw-semibold">
                                                    <i class="bi bi-thermometer-snow text-info me-1"></i>Minimum Temperature <span class="text-danger">*</span>
                                                </label>
                                                <div class="input-group">
                                                    <input type="number" step="0.1" required name="min_tp" class="form-control" id="edit_min_tp" placeholder="5">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="edit_max_tp" class="form-label fw-semibold">
                                                    <i class="bi bi-thermometer-sun text-danger me-1"></i>Maximum Temperature <span class="text-danger">*</span>
                                                </label>
                                                <div class="input-group">
                                                    <input type="number" step="0.1" required name="max_tp" class="form-control" id="edit_max_tp" placeholder="35">
                                                    <span class="input-group-text">°C</span>
                                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="edit_ideal_min_tp" class="form-label fw-semibold">
                                                    <i class="bi bi-thermometer-half text-success me-1"></i>Ideal Min Temperature <span class="text-danger">*</span>
                                                </label>
                                                <div class="input-group">
                                                    <input type="number" step="0.1" required name="ideal_min_tp" class="form-control" id="edit_ideal_min_tp" placeholder="15">
                                                    <span class="input-group-text">°C</span>
                                                </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="edit_ideal_max_tp" class="form-label fw-semibold">
                                                    <i class="bi bi-thermometer-half text-success me-1"></i>Ideal Max Temperature <span class="text-danger">*</span>
                                                </label>
                                                <div class="input-group">
                                                    <input type="number" step="0.1" required name="ideal_max_tp" class="form-control" id="edit_ideal_max_tp" placeholder="25">
                                                    <span class="input-group-text">°C</span>
                                                </div>
                            ...
                            <div class="card border-0 bg-light mt-3">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="edit_water" class="form-label fw-semibold">
                                                    <i class="bi bi-droplet-fill text-primary me-1"></i>Water Requirements <span class="text-danger">*</span>
                                                </label>
                                                <input type="text" required name="water" class="form-control" id="edit_water" placeholder="e.g., Regular watering, drought tolerant">
                                                <x-inline_alert name='water'></x-inline_alert>
                                            </div>

                                            <div class="mb-3">
                                                <label for="edit_repotting" class="form-label fw-semibold">
                                                    <i class="bi bi-arrow-repeat text-info me-1"></i>Repotting <span class="text-danger">*</span>
                                                </label>
                                                <input type="text" required name="repotting" class="form-control" id="edit_repotting" placeholder="e.g., Every 2-3 years">
                                                <x-inline_alert name='repotting'></x-inline_alert>
                                            </div>

                                            <div class="mb-3">
                                                <label for="edit_fertilizer" class="form-label fw-semibold">
                                                    <i class="bi bi-egg text-warning me-1"></i>Fertilizer <span class="text-danger">*</span>
                                                </label>
                                                <input type="text" required name="fertilizer" class="form-control" id="edit_fertilizer" placeholder="e.g., Balanced NPK monthly">
                                                <x-inline_alert name='fertilizer'></x-inline_alert>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="edit_misting" class="form-label fw-semibold">
                                                    <i class="bi bi-cloud-drizzle text-info me-1"></i>Misting <span class="text-danger">*</span>
                                                </label>
                                                <input type="text" required name="misting" class="form-control" id="edit_misting" placeholder="e.g., Daily, not required">
                                                <x-inline_alert name='misting'></x-inline_alert>
                                            </div>

                                            <div class="mb-3">
                                                <label for="edit_pruning" class="form-label fw-semibold">
                                                    <i class="bi bi-scissors text-danger me-1"></i>Pruning <span class="text-danger">*</span>
                                                </label>
                                                <input type="text" required name="pruning" class="form-control" id="edit_pruning" placeholder="e.g., Trim dead leaves regularly">
                                                <x-inline_alert name='pruning'></x-inline_alert>
                                            </div>

                                            <div class="mb-3">
                                                <label for="edit_uses" class="form-label fw-semibold">
                                                    <i class="bi bi-star text-warning me-1"></i>Uses <span class="text-danger">*</span>
                                                </label>
                                                <textarea required name="uses" class="form-control" id="edit_uses" rows="2" placeholder="Describe the plant's uses (medicinal, culinary, ornamental, etc.)"></textarea>
                                                <x-inline_alert name='uses'></x-inline_alert>
                                            </div>

                                            <div class="mb-3">
                                                <label for="edit_cluture" class="form-label fw-semibold">
                                                    <i class="bi bi-globe text-success me-1"></i>Culture <span class="text-danger">*</span>
                                                </label>
                                                <textarea required name="cluture" class="form-control" id="edit_cluture" rows="2" placeholder="Growing conditions and cultural requirements"></textarea>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="edit_pests" class="form-label fw-semibold">
                                                    <i class="bi bi-bug text-danger me-1"></i>Common Pests
                                                </label>
                                                <input type="text" name="pests" class="form-control" id="edit_pests" placeholder="Aphids, spider mites (comma separated)">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="edit_diseases" class="form-label fw-semibold">
                                                    <i class="bi bi-shield-exclamation text-warning me-1"></i>Common Diseases
                                                </label>
                                                <input type="text" name="diseases" class="form-control" id="edit_diseases" placeholder="Root rot, powdery mildew (comma separated)">
                        ...
                        <!-- Classification Tab -->
                        <div class="tab-pane fade" id="edit-classification-info" role="tabpanel">
                            <div class="card border-0 bg-light">
                                <div class="card-body">
                                    <h6 class="card-title text-info mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="edit_section_id" class="form-label fw-semibold">
                                                    <i class="bi bi-collection text-primary me-1"></i>Section <span class="text-danger">*</span>
                                                </label>
                                                <select required name="section_id" class="form-select" id="edit_section_id">
                                            ...
                                            <div class="mb-3">
                                                <label for="edit_genus_id" class="form-label fw-semibold">
                                                    <i class="bi bi-diagram-2 text-success me-1"></i>Genus <span class="text-danger">*</span>
                                                </label>
                                                <select required name="genus_id" class="form-select" id="edit_genus_id">
                                            ...
                                            <div class="mb-3">
                                                <label for="edit_family_id" class="form-label fw-semibold">
                                                    <i class="bi bi-people text-info me-1"></i>Family <span class="text-danger">*</span>
                                                </label>
                                                <select required name="family_id" class="form-select" id="edit_family_id">
                                            ...
                                            <div class="mb-3">
                                                <label for="edit_order_id" class="form-label fw-semibold">
                                                    <i class="bi bi-list-ol text-warning me-1"></i>Order <span class="text-danger">*</span>
                                                </label>
                                                <select required name="order_id" class="form-select" id="edit_order_id">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <label for="edit_group_id" class="form-label fw-semibold">
                                                    <i class="bi bi-collection-fill text-secondary me-1"></i>Group <span class="text-danger">*</span>
                                                </label>
                                                <select required name="group_id" class="form-select" id="edit_group_id">
                                            ...
                                            <div class="mb-3">
                                                <label for="edit_phylum_id" class="form-label fw-semibold">
                                                    <i class="bi bi-tree text-success me-1"></i>Phylum <span class="text-danger">*</span>
                                                </label>
                                                <select required name="phylum_id" class="form-select" id="edit_phylum_id">
                                            ...
                                            <div class="mb-3">
                                                <label for="edit_type_id" class="form-label fw-semibold">
                                                    <i class="bi bi-tag text-danger me-1"></i>Type <span class="text-danger">*</span>
                                                </label>
                                                <select required name="type_id" class="form-select" id="edit_type_id">
                                            ...
                                            <div class="mb-3">
                                                <label for="edit_drainage_id" class="form-label fw-semibold">
                                                    <i class="bi bi-water text-primary me-1"></i>Drainage <span class="text-danger">*</span>
                                                </label>
                                                <select required name="drainage_id" class="form-select" id="edit_drainage_id">
                        ...
                        <!-- Media & Tags Tab -->
                        <div class="tab-pane fade" id="edit-media-info" role="tabpanel">
                            <div class="card border-0 bg-light">
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label fw-semibold">
                                            <i class="bi bi-image text-info me-1"></i>Current Images
                                        </label>
                                    ...
                                    <!-- Upload New Images -->
                                    <div class="mb-3">
                                        <label for="edit_images" class="form-label fw-semibold">
                                            <i class="bi bi-camera text-info me-1"></i>Upload New Images
                                        </label>
                                        <div class="upload-area border-2 border-dashed border-warning rounded p-4 text-center">
                                            <input type="file" name="images[]" class="form-control" id="edit_images" multiple accept="image/*" style="display: none;">
                                            <div class="upload-content">
                                                <i class="bi bi-cloud-upload text-warning" style="font-size: 3rem;"></i>
                                                <h5 class="mt-3 text-warning">Drop images here or click to browse</h5>
                                                <p class="text-muted">Support: JPG, PNG, GIF (Max: 5MB each)</p>
                                                <button type="button" class="btn btn-outline-warning" onclick="document.getElementById('edit_images').click()">
                            ...
                            <div class="card border-0 bg-light mt-3">
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        <label for="edit_tags" class="form-label fw-semibold">
                                            <i class="bi bi-tag text-warning me-1"></i>Tags
                                        </label>
                                        <select name="tags[]" class="form-select" id="edit_tags" multiple>
                                            @foreach($tags as $tag)
                ...
                <div class="modal-footer bg-light">
                    ...
                    <button type="submit" class="btn btn-warning">
                        <i class="bi bi-check-circle me-1"></i>Update Plant
                    </button>
                </div>
            </form>
        </div>
